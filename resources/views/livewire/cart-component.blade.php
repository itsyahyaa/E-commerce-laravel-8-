        ...
        <div class=" main-content-area">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                <input type="text" name="product-quatity" value="{{$item->gty}}" data-max="120" pattern="[0-9]*" >
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    <p class="summary-info"><span class="title"></span>Subtotal<b class="index">${{Cart::subtotal()}}</b></p>

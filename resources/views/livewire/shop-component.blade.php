                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.details',['slug'=>$product->slug])}}" title="{{$product->name}}</span></a>">
                                        <figure><img src="{{ asset('assets/images/products')}}/{{$product->image}}" alt="{{$product->name}}</span></a>"></figure>
                                    </a>
                                </div>
                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="widget-banner">
                            <figure><img src="{{asset('ssets/images/size-banner-widget.jpg')}}" width="270" height="331" alt=""></figure>
                        </div>
                    </div>
                </div><!-- Size -->
